    ...
    <main class="game-container">
        ...
        <div class="keyboard">
            <div class="keyboard-row">
                ...
                <button class="key" data-state="correct" data-key="e">e</button>
                <button class="key" data-state="correct" data-key="r">r</button>
                <button class="key" data-state="absent" data-key="t">t</button>
                <button class="key" data-key="y">y</button>
                <button class="key" data-key="u">u</button>
                <button class="key" data-key="i">i</button>
                <button class="key" data-key="o">o</button>
                <button class="key" data-state="correct" data-key="p">p</button>
            </div>
            <div class="keyboard-row">
                <button class="key" data-state="correct" data-key="a">a</button>
                <button class="key" data-state="absent" data-key="s">s</button>
                <button class="key" data-state="correct" data-key="d">d</button>
                <button class="key" data-state="absent" data-key="f">f</button>
                <button class="key" data-state="absent" data-key="g">g</button>
            ...
            <div class="keyboard-row">
                ...
                <button class="key" data-state="absent" data-key="m">m</button>
